...
|---|---|---|---|
| **Grounded** | Production RAG document assistant | ⟨url⟩ | FastAPI backend · recall@10 & faithfulness evals · Langfuse traces · cost/latency budget |
| **DataChat** | Talk-to-your-Postgres agent | ⟨url⟩ | LangGraph supervisor · SQL + ECharts tool agents · read-only guardrails |
| **multi-agent-lab** | LangGraph supervisor/researcher/writer | — | state graph · conditional routing · deterministic guardrails |
...
Solid API design · evaluation over vibes · observability by default · cost & latency as first-class constraints · guardrails, not just happy paths.
